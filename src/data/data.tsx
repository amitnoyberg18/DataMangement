...
export const dataCardTree = () =>{ 
    const c1 : CardTree={id:1,questionText:"היכן הבעיה",answers:[ "אתר","לא"]}
    const c2 : CardTree={id:2,questionText:" היכן הבעיה באתר",answers:["שאלונים","נתון לא מעודכן באתר","נתון לא נכון באתר","לא מצליח להתחבר לאתר"]}
    const c3 : CardTree={id:3,questionText:"האם התחבר בעבר",answers:[ "לא","כן"]}
    const c4 : CardTree={id:4,questionText:"שילחו קישור לסיסמא ראשונית. הצליח?",answers:[ "לא","כן"]}
    const c5 : CardTree={id:5,questionText:"הביאו סיסמה ראשונית. הצליח?",answers:[ "לא","כן"]}
    const c6 : CardTree={id:6,questionText:"היכנס לטרנזקציה",answers:["תחום","תת תחום","שאלה","תת שאלה","תבנית תשובה בCRM"]}
    const c7 : CardTree={id:7,questionText:"שאלונים",answers:[ "לא","אתר"]}
